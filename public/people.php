...
return $I;
    ...
    }function found_rows($R, $Z) {}function types()
    {
        return [];
    }function schemas()
    {
...
return $I;
    ...
    }function use_sql($j) {}function trigger_sql($Q)
    {
...
return $I;
    }function convert_field($o) {}function unconvert_field($o, $I)
    {
        return $I;
    }function support($Vc)
    {
...
return $I;
    ...
    }function show_status() {}function convert_field($o) {}function unconvert_field($o, $I)
    {
        return $I;
    }function support($Vc)
    {
...
return $I;
    ...
    }function found_rows($R, $Z) {}function auto_increment()
    {
        return '';
    }function alter_table($Q, $D, $p, $hd, $tb, $_c, $mb, $La, $Wf)
    {
...
return (! $w || queries('DROP INDEX '.implode(', ', $w))) && (! $lc || queries('ALTER TABLE '.table($Q).' DROP '.implode(', ', $lc)));
    ...
    }function explain($g, $G)
    {
        ...
        return $I;
    }function found_rows($R, $Z) {}function foreign_keys($Q)
    {
        $I = [];
...
return true;
    ...
    }function db_collation($l, $nb) {}function information_schema() {}function is_view($R) {}function convert_field($o) {}function unconvert_field($o, $I)
    {
        return $I;
    }function foreign_keys($Q)
    {
        return [];
    }function fk_support($R) {}function engines()
    {
        return [];
    }function alter_table($Q, $D, $p, $hd, $tb, $_c, $mb, $La, $Wf)
    {
...
return $I;
    ...
    {
        return [];
    }function db_collation($l, $nb) {}function engines()
    {
        return [];
    }function count_tables($k)
    {
...
return $I;
    }function error()
    {
        ...
        return h($g->error);
    }function information_schema() {}function is_view($R) {}function indexes($Q, $h = null)
    {
...
return $I;
    ...
    {
        return $I;
    }function fk_support($R) {}function found_rows($R, $Z)
    {
        return null;
