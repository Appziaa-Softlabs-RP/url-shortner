...
export default function SkewCard2({ data }: any) {
    ...
    return <div className="relative w-[80%] h-[350px]">
        <div className={cn(
            ...
            "transform skew-[turn(0.05turn)] -skew-y-[-10deg]",
            "flex items-center justify-center"
        )}>
            {/* image */}
            <div
                className="h-[100px] w-[100px] bg-slate-200 absolute top-[-40px] -skew-y-[10deg] rounded-full"
            >
                {data.image ? (
                    <Image
            ...
            <div
                className={cn(
                    ...
                    "absolute top-[70px] skew-y-[-10deg]"
                )}
            >
                ...
                </p>                <div className="flex gap-1 justify-center">
                    {
